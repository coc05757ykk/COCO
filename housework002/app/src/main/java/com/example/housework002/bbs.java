package com.example.housework002;
...
import com.example.housework002.util.DateUtil;
...
public class bbs extends AppCompatActivity implements View.OnClickListener, View.OnLongClickListener {
    ...
    private String[] mChatStr = {"夜空中最亮的星", "我祈祷拥有一颗透明的心灵",
            "我宁愿所有痛苦都留在心里", "每当我找不到存在的意义", "每当我迷失在黑夜里"};
