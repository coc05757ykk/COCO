package com.example.housework_end;
...
import com.example.housework_end.bean.UserInfo;
import com.example.housework_end.database.UserDBHelper;
import com.example.housework_end.util.DateUtil;
import com.example.housework_end.util.ViewUtil;

public class MainLogin extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    private static final String TAG = "MainMenu"; //Log提示信息
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","18990071 杨可可"};
    ...
    private class HideTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if ((mStr.length() == 11 && mMaxLength == 11) || (mStr.length() == 6 && mMaxLength == 6)
                ...
                ViewUtil.hideOneInputMethod(MainLogin.this, mView);
            }
        }
    }
